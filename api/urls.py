...
urlpatterns = [
    ...
    *router.urls,
    ...
    path('issues/<int:issue_id>/', issue_detail, name='issue-detail'),
    ...
    path('issues/<int:issue_id>/watchers/<str:username>/', issue_watcher_remove, name='api-issue-watcher-remove'),
